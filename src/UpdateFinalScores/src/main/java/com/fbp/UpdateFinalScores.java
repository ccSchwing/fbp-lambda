...
public class UpdateFinalScores {
    ...
    public APIGatewayProxyResponseEvent updateFinalScores(APIGatewayProxyRequestEvent request) throws JsonProcessingException {
        ...
        System.out.println("=== Starting updateFinalScores() ===");
