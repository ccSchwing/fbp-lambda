package com.fbp.getpresignedurl;
...
public class GetPreSignedUrlHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        ...
        System.out.println("Initialized GetPreSignedUrlHandler with bucket: " + bucketName + " and region: " + region.id());
        ...
        try {
            ...
            System.out.println("Received request with 'key' parameter: " + (fileKeyObject != null ? fileKeyObject.toString() : "null") + " (type: " + objectType + ")");
            ...
            System.out.println("Generating presigned URL for bucket: " + bucketName + " and key: " + fileKey);
            ...
            return new APIGatewayProxyResponseEvent()
                    .withStatusCode(500)
                    .withHeaders(headers)
                    .withBody(String.format("{\"error\":\"Failed to generate presigned URL\",\"message\":\"%s\"}", e.getMessage()));
        }
    }
}
